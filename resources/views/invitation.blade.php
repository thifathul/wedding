...
<head>
    ...
    <title>The Wedding of {{ $settings->bride_name ?? 'Anisa' }} & {{ $settings->groom_name ?? 'Candra' }}</title>
    <!-- Google Fonts -->
...
<body>
    ...
    <div id="cover" class="cover-wrapper">
        <div class="cover-left" style="background-image: url('{{ $settings && $settings->desktop_bg_image ? asset($settings->desktop_bg_image) : 'https://hi.rumahundangan.in/wp-content/uploads/2025/11/VINTAGE-06.webp' }}');">
            <div class="desktop-quote" data-aos="fade-up">
        ...
        <div class="cover-right" style="background-image: url('{{ $settings && $settings->cover_image ? asset($settings->cover_image) : 'https://hi.rumahundangan.in/wp-content/uploads/2025/08/VINTAGE-54.webp' }}');">
            ...
            <div class="cover-content">
                <h3 data-aos="fade-down">The Wedding of</h3>
                <h1 class="couple-name" data-aos="zoom-in" data-aos-delay="200">{{ $settings->bride_name ?? 'Anisa' }} & {{ $settings->groom_name ?? 'Candra' }}</h1>
                <p data-aos="fade-up" data-aos-delay="400">Dear</p>
                <h2 class="recipient-name" data-aos="fade-up" data-aos-delay="600">{{ $recipient }}</h2>
                <button id="open-btn" class="btn-open" data-aos="fade-up" data-aos-delay="800">
                    Buka Undangan
                </button>
            </div>
        </div>
    ...
    <div id="main-content" style="display: none;">
        ...
        <section class="hero-section" id="hero">
            ...
            <div class="hero-content text-center">
                <h3 data-aos="fade-down" data-aos-duration="1500">The Wedding of</h3>
                <h1 class="couple-name lg" data-aos="zoom-in" data-aos-duration="2000">{{ $settings->bride_name ?? 'Anisa' }}<br>& {{ $settings->groom_name ?? 'Candra' }}</h1>
                <h3 data-aos="fade-up" data-aos-duration="1500">{{ $settings->wedding_date ?? '07 . 06 . 2026' }}</h3>
            </div>
        </section>
        ...
        <section class="couple-section section-padding" id="couple">
            <div class="container text-center">
                ...
                <div class="couple-wrapper">
                    <!-- Groom -->
                    <div class="couple-box" data-aos="fade-right">
                        <div class="couple-img-wrapper arch-frame">
                            <svg class="frame-border" width="220" height="280" viewBox="0 0 220 280" xmlns="http://www.w3.org/2000/svg">
                                <path d="M110 12 C130 22, 148 32, 168 32 C188 32, 208 52, 208 82 L208 218 C208 238, 188 248, 168 248 C148 248, 130 258, 110 273 C90 258, 72 248, 52 248 C32 248, 12 238, 12 218 L12 82 C12 52, 32 32, 52 32 C72 32, 90 22, 110 12 Z" fill="none" stroke="#d4af37" stroke-width="4"/>
                            </svg>
                    ...
                    <h1 class="and-text" data-aos="zoom-in">&</h1>
                    
                    <!-- Bride -->
                    <div class="couple-box" data-aos="fade-left">
                        <div class="couple-img-wrapper arch-frame">
                            <svg class="frame-border" width="220" height="280" viewBox="0 0 220 280" xmlns="http://www.w3.org/2000/svg">
                                <path d="M110 12 C130 22, 148 32, 168 32 C188 32, 208 52, 208 82 L208 218 C208 238, 188 248, 168 248 C148 248, 130 258, 110 273 C90 258, 72 248, 52 248 C32 248, 12 238, 12 218 L12 82 C12 52, 32 32, 52 32 C72 32, 90 22, 110 12 Z" fill="none" stroke="#d4af37" stroke-width="4"/>
                            </svg>
        ...
        <section class="video-momen-section section-padding text-center" id="video-momen">
            <div class="container">
                <h2 class="section-title" data-aos="fade-up">Video Momen</h2>
                <div class="video-wrapper" data-aos="fade-up" data-aos-delay="200" style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.1); border: 2px solid rgba(255, 255, 255, 0.3);">
        ...
        <section class="gallery-section section-padding text-center" id="gallery">
            <div class="container">
                <h2 class="section-title" data-aos="fade-up">Galeri Momen</h2>
        ...
        <section class="rsvp-section section-padding" id="rsvp">
            <div class="container">
                <h2 class="section-title text-center" data-aos="fade-up">RSVP & Ucapan</h2>
                
                <div class="rsvp-form-container" data-aos="fade-up">
                    <form id="rsvp-form">
                ...
                <div class="guestbook-container" data-aos="fade-up">
        ...
        <section class="gift-section section-padding text-center" id="gift">
            <div class="container">
                ...
                <p data-aos="fade-up">Bagi bapak/ibu/saudara/i yang ingin memberikan tanda kasih, dapat melalui nomor rekening di bawah ini:</p>
                
                <div class="banks-wrapper" style="display: flex; gap: 20px; justify-content: center; flex-wrap: wrap;">
                    <div class="bank-card" data-aos="fade-up" data-aos-delay="200" style="margin-top: 30px; margin-left: auto; margin-right: auto; flex: 1; min-width: 280px; max-width: 400px;">
                    ...
                    <div class="bank-card" data-aos="fade-up" data-aos-delay="400" style="margin-top: 30px; margin-left: auto; margin-right: auto; flex: 1; min-width: 280px; max-width: 400px;">
